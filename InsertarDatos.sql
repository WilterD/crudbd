...
VALUES 
    ('1234567890', 'Juan PErez', 'Calle 123', '555-5555', 'A', 'TC', '2011-12-31', '2022-12-20', 'P'),
    ('2345678901', 'María Gomez', 'Avenida 456', '555-5556', 'I', 'MT', '2010-01-15', '2022-12-19', 'A'),
    ('3456789012', 'Pedro Torres', 'Calle 789', '555-5557', 'S', 'TC', '2009-06-30', '2022-12-11', 'R'),
    ('4567890123', 'Ana Garcia', 'Avenida 012', '555-5558', 'I', 'MT', '2008-03-12', '2022-10-10', 'P'),
    ('5678901034', 'Carlos Hernandez', 'Calle 345', '555-5559', 'G', 'TC', '2007-09-22', '2022-10-29', 'J'),
    ('6789012345', 'Luisa Martinez', 'Avenida 678', '555-5560', 'I', 'MT', '2006-11-18', '2022-12-16', 'P'),
    ('7890123456', 'Diego Sanchez', 'Calle 901', '555-5561', 'A', 'TV', '2005-05-01', '2022-12-15', 'A'),
    ('8901234567', 'Laura Rodriguez', 'Avenida 234', '555-5562', 'G', 'TV', '2004-07-09', '2022-10-14', 'R'),
    ('9011345678', 'Santiago Perez', 'Calle 567', '555-5563', 'T', 'TC', '2003-02-28', '2022-10-12', 'P'),
    ('0123456789', 'Carolina Gomez', 'Avenida 890', '555-5564', 'G', 'TV', '2002-10-17', '2022-12-25', 'J'),
    ('312399913', 'Carolina Paez', 'Avenida 890', '555-5564', 'I', 'MT', '2002-10-17', '2022-5-24', 'J'),
    ('312399914', 'Hector Sanchez', 'Avenida 290', '5534-5564', 'I', 'MT', '2002-9-17', '2022-4-22', 'A'),
    ('312393943', 'Maria Sanchez', 'Avenida 290', '5534-5564', 'I', 'MT', '2002-8-17', '2022-2-24', 'A');
